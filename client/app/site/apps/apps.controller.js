...
(function () {
    ...
    let _services = [
        {
            name:'ccc',
            fullName: 'Call Center Compliance',
        ...
        {
            name:'tfsb',
            fullName: 'Trueforce Quick Start for Salesforce Bronze',
        ...
        {
            name:'tfss',
            fullName: 'Trueforce Quick Start for Salesforce Silver',
            description: 'Trueforce offers the ability to get up and running with Salesforce quickly. Packages offer system configuration, set up, data migration and training. Custom packages are also available.',
        ...
        {
            name:'tfsg',
            fullName: 'Trueforce Quick Start for Salesforce Gold',
            description: 'Trueforce offers the ability to get up and running with Salesforce quickly. Packages offer system configuration, set up, data migration and training. Custom packages are also available.',
